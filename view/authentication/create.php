<form method="post" action="create" class="container" enctype="multipart/form-data">
    <div class="form-horizontal ">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                <label  class="control-label col-sm-12"><input type="checkbox" value=""> Ik accepteer de algemene voorwaarden van TZT post</label>
            </div>
